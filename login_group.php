        ...
        <div class="login-box design">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg" style="color:black;">Enter Your Group Code</p>
                    <form action="config/aksi_login.php" method="post">
                        <div class="input-group mb-3"><input type="text" name="group_codex" required="3" class="form-control" placeholder="Enter Group Code">
                            <div class="input-group-append">
                                <div class="input-group-text"><span class="fas fa-code"></span></div>
                            </div>
                        </div>
                        <div class="input-group mb-3"><input type="password" name="group_pwdx" required="3" class="form-control" placeholder="Enter Group Password">
                            <div class="input-group-append">
                    ...
                    <!-- /.social-auth-links -->
                    <p class="mt-2"><a href="create_group.php" class="text-center">Create new group</a></p>
