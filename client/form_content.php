...
<head>
    ...
    <title>SMARTNOTE | FORM CONTENT</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Form Content</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="profile_group.php" class="d-block"><?= $data['group_name']; ?></a>
                    </div>
                </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="tabel_group.php">Content</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form role="form" action="../config/tambah_content.php" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input type="hidden" required="3" name="id_contentx" class="form-control" placeholder="Enter Id Content" value="<?php echo date('dmYhis'); ?>">
                                            <label for="judul">Judul Content</label>
                                            <input type="text" required="3" name="judul_contentx" class="form-control" placeholder="Enter Judul Content">
                                        </div>
                                        <div class="form-group">
                                            <label for="isi">Isi Content</label>
                                            <textarea class="form-control" required="2" placeholder="Enter Isi Content" name="isi_contentx"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="tanggal">Tanggal</label>
                                            <input type="text" readonly required="3" name="tanggalx" class="form-control" placeholder="Enter Tanggal" value="<?php echo date('Y-m-d');  ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="jam">Jam</label>
                                            <input readonly type="text" required="3" name="jamx" class="form-control" placeholder="Enter Jam" value="<?php echo date('h : i : s : A'); ?>">
                                        </div>
                                        <input type="hidden" required="3" name="id_groupx" class="form-control" placeholder="Enter Group ID" value="<?php echo $id; ?>">
                                    </div>
                                    <!-- /.card-body -->
