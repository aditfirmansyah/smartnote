...
<head>
    ...
    <title>SMARTNOTE | FORM GROUP</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="tabel_group.php" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?php echo $data10['group_name']; ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="tabel_group.php" class="nav-link bg-purple">
                        ...
                        <li class="nav-item">
                            <a href="tabel_content.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="tabel_diskusi.php" class="nav-link">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="tabel_group.php">Tabel Group</a></li>
                                <li class="breadcrumb-item active">Group Form</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form role="form" action="../config/edit_group.php" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Group Name</label>
                                            <input type="hidden" required="3" name="group_id" class="form-control" value="<?php echo $data['id_group']; ?>">
                                            <input type="text" required="3" name="group_namex" class="form-control" id="exampleInputEmail1" placeholder="Enter Group Name" value="<?php echo $data['group_name']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Group Code</label>
                                            <input type="text" required="3" name="group_codex" class="form-control" id="exampleInputEmail1" placeholder="Enter Group Code" value="<?php echo $data['group_code']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Group Pasword</label>
                                            <input type="password" required="3" name="group_pwdx" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" id="exampleInputPassword1" placeholder="Enter Group Password" value="<?php echo $data['group_password']; ?>">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
